...
{
	int i = 0;
	char modelnames[NUMBER_OF_MODELS][64] = {"Models/asd.obj", "Models/penguin.obj", "Models/ground.obj", "Models/sword.obj", "Models/menu.obj"};
	char texturenames[NUMBER_OF_MODELS][64] = {"Textures/asd123.png", "Textures/penguin.jpg", "Textures/ground.jpg", "Textures/sword.jfif", "Textures/drug.png"};

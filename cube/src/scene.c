...
void init_scene(Scene *scene)
{
    ...
    load_model(&(scene->sword), "assets/models/sword.obj");
    scene->sword_texture_id = load_texture("assets/textures/sword.jpg");
...
void render_scene(const Scene *scene)
{
    ...
    glTranslatef(0.5, scene->sword_y, 1);
    glScalef(0.5, 0.5, 0.5);
    glBindTexture(GL_TEXTURE_2D, scene->sword_texture_id);
    glRotated(0, 1, 0, 0);
